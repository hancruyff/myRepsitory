    ...
    public partial class Form5 : Form
    {
        ...
        private void comboBox3_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "select 시간 from 운행시간표 where 열차번호=" + comboBox3.SelectedItem.ToString() + " and 역이름='" + comboBox1.SelectedItem.ToString() + "' and 방향='" + Direction + "'"; ;
                cmd.CommandType = CommandType.Text;
                cmd.Connection = conn;
                read = cmd.ExecuteReader();
                while (read.Read())
                {
                    Object obj = new Object();
                    obj = read.GetValue(0);
                    label5.Text = "출발시간 "+obj.ToString();
                }read.Close();
                cmd.CommandText = "select 시간 from 운행시간표 where 열차번호=" + comboBox3.SelectedItem.ToString() + " and 역이름='" + comboBox2.SelectedItem.ToString() + "' and 방향='" + Direction + "'"; ;
                cmd.CommandType = CommandType.Text;
                cmd.Connection = conn;
                read = cmd.ExecuteReader();
                while (read.Read())
                {
                    Object obj = new Object();
                    obj = read.GetValue(0);
                    label11.Text = "도착시간 " + obj.ToString();
                }
                read.Close();
            }
            catch (Exception ex)
